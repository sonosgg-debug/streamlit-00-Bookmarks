...
<head>
    ...
    <style>
        ...
        .card-color-default:hover {
            ...
            border-color: #10b981 !important; /* Emerald green highlight */
            box-shadow: 0 10px 15px -3px rgba(16, 185, 129, 0.15) !important;
        }

        .card-color-orange {
            background: linear-gradient(135deg, #2d1a0f, #1f0f08) !important;
            border: 1px solid #f97316 !important;
        }
        .card-color-orange:hover {
            transform: translateY(-2px);
            border-color: #ffedd5 !important; /* Soft orange/cream highlight */
            box-shadow: 0 10px 15px -3px rgba(249, 115, 22, 0.2) !important;
        }

        .card-color-green {
            background: linear-gradient(135deg, #0f2d1a, #081f11) !important;
            border: 1px solid #22c55e !important;
        }
        .card-color-green:hover {
            transform: translateY(-2px);
            border-color: #dcfce7 !important; /* Soft green highlight */
            box-shadow: 0 10px 15px -3px rgba(34, 197, 94, 0.2) !important;
        }

        .card-color-yellow {
            background: linear-gradient(135deg, #2d290f, #1f1c08) !important;
            border: 1px solid #eab308 !important;
        }
        .card-color-yellow:hover {
            transform: translateY(-2px);
            border-color: #fef9c3 !important; /* Soft yellow highlight */
    ...
    <script>
        ...
        function renderGrid(bookmarks, deleteId) {
            ...
            bookmarks.forEach((item, index) => {
                ...
                const colorClass = item.color ? 'card-color-' + item.color : 'card-color-default';
                card.className = "bookmark-card " + colorClass;
